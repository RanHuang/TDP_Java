...
import com.nick.tdp.socket.KeyConstant;
import com.nick.tdp.socket.SocketKeyValueObject;
...
//            LogToScreen.getInstance().logToScreen("Round 1 Pair ID: " + pairID);
...
//            LogToScreen.getInstance().logToScreen("Round 2, Pair U: " + _UEcPointPair.toString());
...
//            LogToScreen.getInstance().logToScreen("Round 3, Pair C: " + _CbytePair.toString());
...
//            LogToScreen.getInstance().logToScreen("Round 4, Pair F: " + _FbytePair.toString());
...
//            LogToScreen.getInstance().logToScreen("Socket end!");
        	_isRunning = false;
        	return;
